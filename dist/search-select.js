 ...
 * search-select
 * 
 * Version: 1.0.0 - 2016-09-19T05:29:09.050Z
 * License: MIT
 */
  ...
  function searchSelect() {
    ...
    function SearchSelectController($scope) {
      ...
      function keyboardNavigation(e){
        ...
        if (key === 40){
          console.log(vm.filteredOptions.length, vm.keyboardFocusIndex);
          if (vm.keyboardFocusIndex === null){
